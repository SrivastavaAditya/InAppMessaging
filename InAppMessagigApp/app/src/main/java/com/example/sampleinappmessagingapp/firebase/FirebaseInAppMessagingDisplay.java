...
import com.example.sampleinappmessagingapp.firebase.wrappers.BindingWrapperFactory;
...
public class FirebaseInAppMessagingDisplay extends FirebaseInAppMessagingDisplayImpl {
    ...
    public void onActivityStarted(final Activity activity) {
        ...
        headlessInAppMessaging.setMessageDisplayComponent(
                new com.google.firebase.inappmessaging.FirebaseInAppMessagingDisplay() {
                    @Override
                    public void displayMessage(@NonNull InAppMessage iam, @NonNull FirebaseInAppMessagingDisplayCallbacks cb) {
    ...
    private void inflateBinding(final Activity activity, final BindingWrapper bindingWrapper) {
        ...
        // button is
        // clicked;
        for (final Action action : extractActions(inAppMessage)) {
